...
class PersistOperationTest extends TestCase
{
    ...
    public function testShouldExecute(): void
    {
        ...
        $operation = $this->createPersistOperation();
        $operation->execute(new \stdClass());
    }

    public function createPersistOperation(): OperationInterface
    {
    ...
    public function testShouldReturnOperationName(): void
    {
        ...
        $this->assertEquals('persist', $operation->getName());
    }
    ...
    public function testShouldReturnOperationPreEventName(): void
    {
        ...
        $this->assertEquals(
            'sauls.object_registry.event.pre_doctrine_object_batch_save',
    ...
    public function testShouldReturnOperationPostEventName(): void
    {
        ...
        $this->assertEquals(
            'sauls.object_registry.event.post_doctrine_object_batch_save',
